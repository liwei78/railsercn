...
<a href="http://www.kernel.org/pub/software/scm/git/docs/gittutorial-2.html">gittutorial-2(7)</a>
<a href="http://www.kernel.org/pub/software/scm/git/docs/gitcvs-migration.html">gitcvs-migration(7)</a>
<a href="http://www.kernel.org/pub/software/scm/git/docs/gitcore-tutorial.html">gitcore-tutorial(7)</a>
<a href="http://www.kernel.org/pub/software/scm/git/docs/gitglossary.html">gitglossary(7)</a>
<a href="http://www.kernel.org/pub/software/scm/git/docs/everyday.html">Everyday git</a>
<a href="http://www.kernel.org/pub/software/scm/git/docs/user-manual.html">The Git User's Manual</a>

补充几句：那篇虽然是2年前的中文教程，但是内容还是很精要的。一些命令已经改动，读的时候小心。比如 git status。难怪我最开始的时候总是不成功呢。
