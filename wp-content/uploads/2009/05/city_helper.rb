module CityHelper
  ...
  module FormBuilder
    def famous_select(id, options = {}, html_options = {})
      @template.famous_select @object_name, id, options, html_options
    end
  ...
  module ViewHelper
    ...
    def famous_select(object, id, options = {}, html_options = {})
      self.select object, id, famous_choices, options, html_options
    end
    ...
    def script_for_state_and_city_select(object, state_id, city_id)
      ...
      %(<script type='text/javascript'>
        #{script}
        function init_city_select(state,city) {
    ...
    def famous_select_tag(id, options = {})
      self.select_tag id, options_for_select(famous_choices), options
    end
