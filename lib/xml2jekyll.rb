...
WORDPRESS_XML_FILE_PATH = "#{ENV['PWD']}/_backup/wordpress.xml"
OUTPUT_PATH = "#{ENV['PWD']}/_drafts"
ORIGINAL_DOMAIN = "http://localhost:4000"
...
class Post
  ...
  def initialize(item)
    ...
    ori_content = item.search("content:encoded").first.inner_text
    text = ClothRed.new(ori_content)
